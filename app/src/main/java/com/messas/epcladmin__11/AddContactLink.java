...
public class AddContactLink extends AppCompatActivity {
    String url,uuid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuth= FirebaseAuth.getInstance();
        firebaseFirestore= FirebaseFirestore.getInstance();
        kProgressHUD= KProgressHUD.create(AddContactLink.this);
        ...
        buttonSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(add_notes_title.getText().toString())||
                    ...
                    firebaseFirestore.collection("Connect")
                            .document("abc@gmail.com").update("email",add_notes_title.getText().toString(),"telegram",blog_detail_desc.getText().toString())
