                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if (task.isSuccessful()) {
                                        if(task.getResult().exists()) {
                                            ...
                                            String number=task.getResult().getString("whatsapp");
                                            ...
                                            if (task.isSuccessful()) {
                                                if (task.getResult().exists()) {
                                                    ...
                                                    builder1 .setTitle("Wallet")
                                                            .setMessage("Main Balance : "+task.getResult().getString("main_balance")+"\n" +
                                                                    ""+"Refer Balance : "+task.getResult().getString("self_income")+"\n" +
                                                                    ""+"Deposit Balance : "+task.getResult().getString("purches_balance")+"\n" )
                                                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                                @Override
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    dialog.dismiss();
