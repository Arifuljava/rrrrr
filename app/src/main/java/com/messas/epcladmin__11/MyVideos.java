...
public class MyVideos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MyVideos.this));
    ...
    private void reciveData() {
        ...
        firebaseFirestore.collection("Daily_videos")
                .document("1")
                .collection("1").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
