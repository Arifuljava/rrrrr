...
public class Glide_bannar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_glide_bannar);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()) {
                               /* HashMap<String,Object> hashMap=new HashMap<>();
                                ...
                                firebaseFirestore.collection("Glodeimage")
                                        .document("abc@gmail.com").update("image",downloadUri.toString())
