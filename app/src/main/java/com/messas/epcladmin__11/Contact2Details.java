...
public class Contact2Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contact2_details);
        ...
        generate_btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edtname.getText().toString())) {
                    Toast.makeText(Contact2Details.this, "Enter name", Toast.LENGTH_SHORT).show();
                }
                else {uploadImage();
                            ...
                            if (uriTask.isSuccessful()) {
                               /* HashMap<String,Object> hashMap=new HashMap<>();
                                ...
                                firebaseFirestore.collection("Service")
                                        ...
                                        .update("image2",downloadUri.toString(),"text2",edtname.getText().toString())
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    progressDialog.dismiss();
                                                    Toast.makeText(Contact2Details.this, "Done", Toast.LENGTH_SHORT).show();
