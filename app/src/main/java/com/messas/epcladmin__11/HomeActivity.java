...
//notification count
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.addpackagess:
                String list11add_videos1[]={"Add Package","Package List"};

                android.app.AlertDialog.Builder builder11add_videoslist11add_videos1=new android.app.AlertDialog.Builder(HomeActivity.this);
                builder11add_videoslist11add_videos1.setTitle("Options")
                        .setItems(list11add_videos1, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (which==0) {
                                    startActivity(new Intent(getApplicationContext(),AddPackages.class));
                                }
                                else if(which==1) {
                                    Intent intent=new Intent(getApplicationContext(),PackageList.class);
                                    intent.putExtra("name","Daily_videos");
            ...
            case R.id.money_shoppin22g:
                ...
                flatDialog311_shoppingmoney_shoppin22g.setTitle("Send balance")
                        .setSubtitle("Are you want send purchase\n balance to user?")
                ...
                break;
                /////waaa
            case R.id.walletbalance44:
                final FlatDialog walletbalance = new FlatDialog(HomeActivity.this);
                walletbalance.setTitle("Send balance")
                        ...
                        .withFirstButtonListner(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                final KProgressHUD progressDialog=  KProgressHUD.create(HomeActivity.this)
                                        ...
                                        .setDimAmount(0.5f)
                                        .show();
                                String name=walletbalance.getFirstTextField().toLowerCase().toString();
                                String scrond=walletbalance.getSecondTextField().toLowerCase().toString();
                                if (TextUtils.isEmpty(name)||TextUtils.isEmpty(scrond)) {
                                    progressDialog.dismiss();
                                                                                            ...
                                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                ...
                                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                                    if (task.isSuccessful()) {
                                                                                                        ...
                                                                                                        String current1 = DateFormat.getDateInstance().format(calendar.getTime());
                                                                                                        String uuid=UUID.randomUUID().toString();
                                                                                                        Sublime1 sublime=new Sublime1(uuid,walletbalance.getFirstTextField().toString(),
                                                                                                                walletbalance.getSecondTextField().toLowerCase(),current1);
                                                                                                        firebaseFirestore.collection("Userrr_All")
                                                                                                                .document(uuid)
                                                                                                                .set(sublime)
                                                                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            case R.id.addtaskk:
                String listvideo[]={"Video 1","Video 2","Video 3","Video 4","Video 5",
                        "Video 6","Video 7","Video 8","Video 9","Video 10"};
                AlertDialog.Builder builderss =new AlertDialog.Builder(HomeActivity.this);
                builderss.setTitle("Video ID Adding Options")
                        .setItems(listvideo, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                if (which==0) {
                                    final EditText input2 = new EditText(HomeActivity.this);
                                    LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(
                                            LinearLayout.LayoutParams.MATCH_PARENT,
                                            LinearLayout.LayoutParams.MATCH_PARENT);
                                    input2.setLayoutParams(lp2);
                                    input2.setGravity(Gravity.CENTER);
                                    input2.setHint("Enter Video ID");

                                    new androidx.appcompat.app.AlertDialog.Builder(HomeActivity.this)
                                            .setTitle("Video 1")
                                            .setMessage("Do not provide video link. Please give us youtube video id.")
                                            .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                                ...
                                                public void onClick(DialogInterface dialogInterface, int i) {
                                                    ...
                                                    {
                                                        Toast.makeText(HomeActivity.this, "Enter Values", Toast.LENGTH_SHORT).show();
                                                    }
                                                    else {

                                                        firebaseFirestore.collection("Videos")
                                                                .document("one")
                                                                .update("videoid",input2.getText().toString())
                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                    @Override
                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                        if (task.isSuccessful()) {
