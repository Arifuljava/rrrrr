...
public class AddHeaderText extends AppCompatActivity {
    String url,uuid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_header_text);
        firebaseAuth=FirebaseAuth.getInstance();
        firebaseFirestore=FirebaseFirestore.getInstance();
        Toolbar toolbar = findViewById(R.id.profile_toolbar);
        firebaseAuth= FirebaseAuth.getInstance();
        firebaseFirestore= FirebaseFirestore.getInstance();
        kProgressHUD= KProgressHUD.create(AddHeaderText.this);
        ...
        buttonSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(add_notes_title.getText().toString())||
                    ...
                    firebaseFirestore.collection("Heading_Text")
                            .document("abc@gmail.com").update("text",blog_detail_desc.getText().toString())
                    ...
                    firebaseFirestore.collection("Notificatios____")
                            .document(ts)
                            .set(chat)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                @Override
